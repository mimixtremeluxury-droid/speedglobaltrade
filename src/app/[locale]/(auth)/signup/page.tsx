...
> = {
  en: {
    ...
    initialFundingLabel: "Initial funding display",
    phoneHint: "onboarding line",
    fundingSummary: "Funding previews will render in {currency}, and your nationality selection is set to {nationality}.",
  },
  es: {
    ...
    initialFundingLabel: "Vista de fondeo inicial",
    phoneHint: "linea de onboarding",
    fundingSummary: "Las vistas de fondeo se mostraran en {currency} y tu nacionalidad actual es {nationality}.",
  },
  zh: {
    phoneNumber: "\u624b\u673a\u53f7",
    nationality: "\u56fd\u7c4d",
    ...
    termsLink: "\u67e5\u770b\u6761\u6b3e",
    initialFundingLabel: "\u521d\u59cb\u5165\u91d1\u9884\u89c8",
    phoneHint: "\u5f00\u6237\u4e13\u7ebf",
    fundingSummary: "\u5165\u91d1\u9884\u89c8\u5c06\u4ee5 {currency} \u663e\u793a\uff0c\u5f53\u524d\u56fd\u7c4d\u4e3a {nationality}\u3002",
  },
  ar: {
    ...
    initialFundingLabel: "\u0639\u0631\u0636 \u0627\u0644\u062a\u0645\u0648\u064a\u0644 \u0627\u0644\u0623\u0648\u0644\u064a",
    phoneHint: "\u062e\u0637 \u0627\u0644\u0627\u0646\u0636\u0645\u0627\u0645",
    fundingSummary: "\u0633\u064a\u062a\u0645 \u0639\u0631\u0636 \u0627\u0644\u062a\u0645\u0648\u064a\u0644 \u0628\u0639\u0645\u0644\u0629 {currency}\u060c \u0648\u0627\u0644\u062c\u0646\u0633\u064a\u0629 \u0627\u0644\u0645\u062d\u062f\u062f\u0629 \u0647\u064a {nationality}.",
  },
  hi: {
    ...
    initialFundingLabel: "\u0936\u0941\u0930\u0941\u0906\u0924\u0940 \u092b\u0902\u0921\u093f\u0902\u0917 \u0926\u0943\u0936\u094d\u092f",
    phoneHint: "\u0911\u0928\u092c\u094b\u0930\u094d\u0921\u093f\u0902\u0917 \u0932\u093e\u0907\u0928",
    fundingSummary: "\u092b\u0902\u0921\u093f\u0902\u0917 \u092a\u094d\u0930\u0940\u0935\u094d\u092f\u0942 {currency} \u092e\u0947\u0902 \u0926\u093f\u0916\u0947\u0917\u093e, \u0914\u0930 \u0906\u092a\u0915\u0940 \u091a\u0941\u0928\u0940 \u0917\u0908 \u0930\u093e\u0937\u094d\u091f\u094d\u0930\u0940\u092f\u0924\u093e {nationality} \u0939\u0948.",
  },
};
          ...
          <aside className="border-b border-white/8 p-6 sm:p-8 lg:border-b-0 lg:border-r">
            <div className="max-w-xl">
              ...
              <div className="surface-soft mt-6 p-5">
                ...
                <div className="mt-5 flex items-center justify-between gap-3 rounded-[1.3rem] border border-white/8 bg-white/[0.02] px-4 py-3">
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.22em] text-body/45">{copy.initialFundingLabel}</p>
